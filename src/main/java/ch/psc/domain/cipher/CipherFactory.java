...
public class CipherFactory {
   ...
   */
    ...
    public static PscCipher createCipher(CipherAlgorithms type) throws FatalImplementationException {
      PscCipher cipher = null;
      
      try {
        cipher = type.getCipherClass().getConstructor().newInstance();
      } catch (NoSuchMethodException | IllegalArgumentException e) {
        throw new FatalImplementationException("Each class inheriting from PscCipher must implement an emtpy constructor!", e);
      }
