...
/**
 * Class to read or write json files contains method to read a json or to write inside a json
 *
...
public class JSONWriterReader {
  ...
  /**
   * Writes object as a json object. Support Lists and simple Objects. Supports
  ...
  public boolean writeToJson(String filePath, Object object) {
    ...
    try (FileWriter writer = new FileWriter(filePath, ENCODING)) {
      String json = FxGson.coreBuilder().setPrettyPrinting().create().toJson(object);
